  ...
  <header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light"> 
      ...
      <div class="font-rale font-size-14">
        <a href="login.php" class="px-3 border-right border-left text-end text-dark">login</a>
          ...
          <ul class="navbar-nav m-auto font-rubik">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <li><a class="dropdown-item" href="#">Cotisen</a></li>
                <li><a class="dropdown-item" href="#">Dental Perfect</a></li>
                <li><a class="dropdown-item" href="#">DTS</a></li>
                <li><a class="dropdown-item" href="#">Suture</a></li>
                <li><a class="dropdown-item" href="#">Skydental</a></li>
